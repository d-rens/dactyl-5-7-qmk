...
[_QWERTY] = LAYOUT_5x7(
    ...
    _______,    KC_F,  KC_L,    KC_H,   KC_V,   KC_Z,   KC_MINS,
    _______,    KC_S,  KC_R,    KC_N,   LT(_SYMBOLS,KC_T),   KC_K,   KC_LBRC,
    _______,    KC_X,  KC_J,    KC_B,   KC_M,   KC_Q,
    _______,    KC_LGUI, TAB_L, TAB_R,
                                                  KC_LSFT, KC_SPC,
                                                  KC_LALT, KC_TAB,   
                                                  KC_LGUI, KC_BTN1,
    // right hand
    ...
    KC_RBRC,    KC_C,    LT(_SYMBOLS,KC_D),    KC_E,     KC_A,     KC_I,     KC_BSLS,
                KC_P,    KC_G,    KC_COMM,  LT(_FN,KC_DOT),     KC_SLSH, KC_SCLN,
...
[_NUMPAD] = LAYOUT_5x7(
    ...
    _______,   _______,   KC_4,      KC_5,      KC_6,      KC_EQL,   _______,
